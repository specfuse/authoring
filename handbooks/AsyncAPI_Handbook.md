...
20. **Do NOT use the per-field `x-pii: true` / `x-sensitive: true` flags.** Use `x-classification: [pii | sensitive | encrypted]` on the entity property schema instead. See `Vendor_Extensions.md §1.5`.
