...
| `v0.3.5` (incubating, current) | generator **`0.3.0`** — `Specfuse/generator-dist` release `v0.3.0`, asset `specfuse-generator-0.3.0.jar`, sha256 `a2cbac69…b686a` | Re-pin to generator 0.3.0. No kit-contract grammar change — the generator bump carries C# codegen work only: unified root/child `Update` apply on `entity.Update(dto)` + layer-aware no-op PATCH short-circuit (#654), producer-aware Response-DTO layer routing + cross-layer guardrail (#703), and fixes #699/#701 (`*Response` namespace, faker literals), #704/#705 (async validator), #709 (integer faker literal), #711 (`Update*` DTO drops schema default), #714 (mixed-root no-op guard). Pin/packaging only. |
