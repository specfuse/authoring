...
description: File a GitHub issue for the Specfuse generator and automatically monitor for resolution. When the generator agent resolves the issue, auto-verify the fix and resume work.
user-invocable: true
allowed-tools: Read Write Edit Bash Grep Glob Agent
argument-hint: <title> [--verify-only <issue-number>]
---
