...
1. Read `handbooks/Arazzo_Handbook.md` -- the full handbook
2. Read `samples/scenario-samples.yaml` -- canonical scenario template
3. Read `samples/recipe-samples.yaml` -- canonical recipe template (for understanding x-setup wiring)
4. Read `.claude/agents/scenario-architect.md` -- the generation agent's input/output contract
5. Read `.claude/agents/scenario-validator.md` -- the validation agent's report format
...
**Tell the agent to:**
1. Read `handbooks/Arazzo_Handbook.md` and `samples/scenario-samples.yaml`
2. Follow the generation process defined in `.claude/agents/scenario-architect.md`
...
Spawn an Agent that:
1. Reads `.claude/agents/scenario-validator.md` for the validation pipeline and report format
