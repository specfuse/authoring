...
1. **Spawn the impact-analyzer agent.** Use the Agent tool with a prompt that:
   - Instructs the agent to read `.claude/agents/impact-analyzer.md` for its full analysis pipeline
