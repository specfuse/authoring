...
3. **Spawn the scenario-reviewer agent.** Use the Agent tool with a prompt that:
   - Instructs the agent to read `.claude/agents/scenario-reviewer.md` for its full review process
