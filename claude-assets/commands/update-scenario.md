...
1. Read `handbooks/Arazzo_Handbook.md` -- especially Section 10 (versioning and deprecation), Section 13 (Do/Don't)
2. Read `samples/scenario-samples.yaml` -- canonical scenario template
...
2. Spawn an Agent to run validation, following the pipeline from `.claude/agents/scenario-validator.md`:
