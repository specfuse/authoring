...
| `handbooks/AI_Access_Policy_Framework.md` | Section refs for §5 entity reclassifications |
...
- **Policy reference:** [`handbooks/AI_Access_Policy_Framework.md` §{policyDocSection}](../../handbooks/AI_Access_Policy_Framework.md#{policyDocSection})
```
